...
void check_rotary_encoder() {
  ...
  if (step != 0) {
    ...
    #ifdef FEATURE_WINKEY_EMULATION                       // Start of Winkey Speed change mod for Rotary Encoder -- VE2EVN
    ...
    #endif                                               // End of Winkey Speed change mod for Rotary Encoder -- VE2EVN
  }                                                      // if (step != 0)
}                                                        // end check_rotary_encoder()
